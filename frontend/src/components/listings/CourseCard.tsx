...
const CourseCard: React.FC<CourseCardProps> = ({
  ...
  return (
    <div className="px-3 pt-3 pb-2 w-[320px] bg-white/20 rounded-xl ring-1 ring-gray-200 shadow hover:translate-y-1 hover:shadow-lg cursor-pointer">
      <div className="relative w-full h-[160px]">
        ...
        <div className="absolute bottom-0 rounded-bl-xl bg-red-500 px-3 py-1 text-sm text-white">
          {time && countdownDaysToEvent(time)}
        </div>
      </div>
